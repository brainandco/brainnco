 ...
 *   on the server: `RESEND_API_KEY`, `RESEND_CONTACT_FROM`, `RESEND_NEWSLETTER_FROM` (verified mailboxes in <>; the
 *   visible From name is built from the person submitting each form).
