    ...
    <section ref={ref} className="pt-32 pb-16 lg:pt-40 lg:pb-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1
            className={cn(
              "mt-4 font-serif text-4xl font-bold tracking-tight text-primary sm:text-5xl lg:text-6xl opacity-0",
          ...
          >
            Expert perspectives on marketing strategy, growth tactics, and industry trends to help you stay ahead.
          </p>
        </div>
      </div>
    </section>
