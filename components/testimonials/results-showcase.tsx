      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {metrics.map((metric, i) => (
            ...
            >
              <div className="rounded-2xl border border-primary-foreground/12 p-8 text-center transition-all duration-300 hover:border-on-primary-bright/50">
                <p className="font-serif text-4xl font-bold text-on-primary-bright lg:text-5xl">
                  {metric.value}
                </p>
