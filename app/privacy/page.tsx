      ...
      <section className="pb-24 lg:pb-32">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <div className="prose prose-neutral dark:prose-invert max-w-none text-foreground">
            <h2 className="mt-10 font-serif text-xl font-bold text-foreground sm:text-2xl">
              1. Introduction
            </h2>
            ...
            <ul className="mt-4 list-disc pl-6 space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">Directly from you:</strong> When you complete contact or inquiry forms, sign up for newsletters, email us, engage in client or prospect communications, or provide information in meetings or contracts.</li>
              <li><strong className="text-foreground">Automatically:</strong> When you visit our website, through cookies and similar tracking technologies that collect usage and technical data as described in this policy.</li>
              <li><strong className="text-foreground">From third parties:</strong> We may receive data from analytics providers, social media platforms (where you interact with our content or ads), advertising partners, and other service providers that support our business and website.</li>
            </ul>
            ...
            <ul className="mt-3 list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">Service providers:</strong> With third parties that help us operate our business and website, such as hosting providers, email and communication tools, analytics and advertising platforms, payment processors, and CRM or marketing automation tools. These providers are contractually required to use your data only for the purposes we specify and in line with applicable law.</li>
              <li><strong className="text-foreground">Legal and safety:</strong> Where required by law, court order, or government or law enforcement request, or when we believe disclosure is necessary to protect our rights, your safety, or the safety of others, or to investigate fraud or security issues.</li>
              <li><strong className="text-foreground">Business transfers:</strong> In connection with a merger, sale of assets, or other corporate change, in which case your data may be transferred as part of that transaction, subject to this policy and applicable law.</li>
            </ul>
            <p className="mt-4 leading-relaxed text-muted-foreground">
            ...
            <ul className="mt-3 list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">Access:</strong> To request a copy of the personal data we hold about you.</li>
              <li><strong className="text-foreground">Correction:</strong> To request that we correct or update inaccurate or incomplete personal data.</li>
              <li><strong className="text-foreground">Deletion:</strong> To request that we delete your personal data, subject to certain legal exceptions (e.g., where we must retain data for legal or contractual reasons).</li>
              <li><strong className="text-foreground">Restriction and portability:</strong> In some jurisdictions (e.g., under GDPR), to request restriction of processing or to receive your data in a portable format.</li>
              <li><strong className="text-foreground">Opt-out of marketing:</strong> To unsubscribe from marketing emails at any time via the link in our emails or by contacting us, and to opt out of certain cookies or tracking as described in this policy.</li>
              <li><strong className="text-foreground">Objection:</strong> Where we rely on legitimate interests, to object to processing of your data on grounds relating to your situation; and, where applicable, to object to processing for direct marketing.</li>
              <li><strong className="text-foreground">Withdraw consent:</strong> Where we rely on your consent, to withdraw it at any time without affecting the lawfulness of processing before withdrawal.</li>
            </ul>
            <p className="mt-4 leading-relaxed text-muted-foreground">
            ...
            <ul className="mt-3 list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">Strictly necessary:</strong> Required for the website to function (e.g., security, load balancing). These generally cannot be disabled.</li>
              <li><strong className="text-foreground">Functional:</strong> Remember your preferences and choices to improve your experience.</li>
              <li><strong className="text-foreground">Analytical:</strong> Help us understand how visitors use our site (e.g., page views, traffic sources). We may use tools such as Google Analytics or similar services.</li>
              <li><strong className="text-foreground">Advertising:</strong> Used to deliver and measure ads, including on other sites, and may be set by us or our advertising partners.</li>
            </ul>
            <p className="mt-4 leading-relaxed text-muted-foreground">
            ...
            <ul className="mt-4 list-none space-y-1 text-muted-foreground pl-0">
              <li><strong className="text-foreground">brain & co.</strong></li>
              <li>Email: <a href="mailto:contact@brainnco.com" className="text-foreground underline underline-offset-4 hover:no-underline">contact@brainnco.com</a></li>
              <li>Website: <Link href="/contact" className="text-foreground underline underline-offset-4 hover:no-underline">Contact page</Link></li>
            </ul>
            <p className="mt-4 leading-relaxed text-muted-foreground">
