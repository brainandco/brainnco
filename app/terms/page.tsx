      ...
      <section className="pb-24 lg:pb-32">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <div className="prose prose-neutral dark:prose-invert max-w-none text-foreground">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              We will respond to inquiries in a reasonable time. For matters related to data privacy, please refer to our <Link href="/privacy" className="text-foreground underline underline-offset-4 hover:no-underline">Privacy Policy</Link>.
            </p>
